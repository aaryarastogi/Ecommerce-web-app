            ...
            <Table>
                <TableBody>
                    <TableText>
                        ...
                        <TableCell style={{ fontWeight: 600, color: 'white' }}>Delivery by {date.toDateString()} | ₹40</TableCell>
                    </TableText>
                    <TableText>
                        <TableCell style={{ color: '#878787' }}>Warranty</TableCell>
                        <TableCell style={{ color: 'white' }}>No Warranty</TableCell>
                    </TableText>
                    <TableText>
                        <TableCell style={{ color: '#878787' }}>Seller</TableCell>
                        <TableCell>
                            <Box component="span" style={{ color: '#F2F2F2' }}>Super ComNet</Box>
                            <Typography style={{ color: 'white' }}>GST invoice available</Typography>
                            <Typography style={{ color: 'white' }}>View more sellers starting from ₹{product.price.cost}</Typography>
                        </TableCell>
                    </TableText>
                    {/* <TableText>
                        <TableCell colSpan={2}>
